...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: <Globe size={18} />, href: "https://linkedin.com/in/codewithkinu", label: "LinkedIn" },
    { icon: <MessageSquare size={18} />, href: "https://instagram.com/dubbinut", label: "Instagram" },
    { icon: <Play size={18} />, href: "https://youtube.com/@codewithkinu", label: "YouTube" },
    { icon: <Code2 size={18} />, href: "https://github.com/sahilmd01", label: "GitHub" },
  ];
