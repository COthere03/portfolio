...
import charpIcon from "@/assets/icons/csharp.png";
...
const skills = [
  ...
  { name: "MS SQL Server", level: 80, category: "backend", icon: "sqlserver" },
  ...
  { name: "PHP", level: 90, category: "languages", icon: "php" },
  { name: "Python", level: 95, category: "languages", icon: "python" },
  { name: "C#", level: 90, category: "languages", icon: "csharp" },
  { name: "Bash", level: 95, category: "languages", icon: "bash" },
  { name: "PowerShell", level: 95, category: "languages", icon: "powershell" },
  ...
  { name: "Jira", level: 95, category: "tools", icon: "jira" },
...
const categories = [
  ...
  { id: "languages", label: "Languages", color: "bg-gradient-to-r from-red-500 to-pink-500" },
];
